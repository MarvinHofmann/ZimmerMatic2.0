          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-12 text-black text-center">
                ...
                />
                <label class="btn btn-outline-primary btn-lg" for="checkboxBL"
                  >Bett Links</label
                >
                ...
                <input
                  ...
                  v-model="checkedSpots"
                />
                <label class="btn btn-outline-primary btn-lg" for="checkboxBR"
                  >Bett Rechts</label
                >
                ...
                <input
                  ...
                  v-model="checkedSpots"
                />
                <label class="btn btn-outline-primary btn-lg" for="checkboxBT"
                  >Basteltisch</label
                >
              </div>
            </div>
